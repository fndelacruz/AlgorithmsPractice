...
def solution(n, a)
  ...
  a.each do |el|
    if el == n + 1
      ...
      counter_idx = el - 1
      if max_counter > counters[counter_idx]
        counters[counter_idx] = max_counter
      end
      counters[counter_idx] += 1
      count = counters[counter_idx]
  ...
  (0...n).each do |idx|
    counter_idx = idx - 1
    counters[counter_idx] = max_counter if counters[counter_idx] < max_counter
  end

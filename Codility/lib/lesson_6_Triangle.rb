...
def solution(a)
  ...
  # assume any triangular triplets in a sorted area are consecutive integers
  (0..a.length - 3).each do |start_idx|
    el1 = a_sorted[start_idx]
    el2 = a_sorted[start_idx + 1]
    el3 = a_sorted[start_idx + 2]
    return 1 if el1 + el2 > el3 && el2 + el3 > el1 && el3 + el1 > el2
  end
  0
end
